...
| Video Upscale | `vid_upscale` | Upscale videos to higher resolution — sharpen, restore, and enlarge video content. |
| Transcribe (Unified) | `transcribe` | Unified transcription — auto-detects URL or file upload. Replaces vid2txt, aud2txt, videofile2txt, audiofile2txt. |
| Video Replace | `videos_replace` | Replace a person in a video with a character from a reference image. |
