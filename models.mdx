...
| Text-to-Image /<br />Image-to-Image | Generate images from text / edit existing image | Fast text-to-image generation and multi-reference image editing in a single unified model. Ideal for real-time applications, local development, and edge deployment. | FLUX.2 Klein 4B BF16     | `Flux2Klein4B_BF16`            | `txt2img`<br />`img2img` |
