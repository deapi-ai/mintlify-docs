...
| `/api/v2/images/upscales`                   | `RealESRGAN_x4plus`                                                       | 5   | 100 |
| `/api/v2/videos/generations`                | `Ltxv_13B_0_9_8_Distilled_FP8`, `Ltx2_19B_Dist_FP8`, `Ltx2_3_19B_Dist_INT8` | 1   | 15  |
| `/api/v2/videos/animations`                 | `Ltxv_13B_0_9_8_Distilled_FP8`, `Ltx2_19B_Dist_FP8`, `Ltx2_3_19B_Dist_INT8` | 1   | 15  |
| `/api/v2/videos/audio-syncs`                | `Ltx2_3_19B_Dist_INT8`                                                    | 1   | 15  |
| `/api/v2/videos/replacements`               | (see Model Selection)                                                     | 1   | 15  |
| `/api/v2/videos/background-removals`        | (see Model Selection)                                                     | 1   | 15  |
| `/api/v2/videos/upscales`                   | `RealESRGAN_x4plus`                                                       | 1   | 15  |
| `/api/v2/audio/speech`                      | `Kokoro`, `Chatterbox`, `Qwen3_TTS`                                       | 5   | 300 |
| `/api/v2/audio/music`                       | `ACE-Step-v1.5-turbo`                                                     | 1   | 15  |
...
| `/api/v2/images/upscales`                   | `RealESRGAN_x4plus`                                                       | 300 | Unlimited |
| `/api/v2/videos/generations`                | `Ltxv_13B_0_9_8_Distilled_FP8`, `Ltx2_19B_Dist_FP8`, `Ltx2_3_19B_Dist_INT8` | 300 | Unlimited |
| `/api/v2/videos/animations`                 | `Ltxv_13B_0_9_8_Distilled_FP8`, `Ltx2_19B_Dist_FP8`, `Ltx2_3_19B_Dist_INT8` | 300 | Unlimited |
| `/api/v2/videos/audio-syncs`                | `Ltx2_3_19B_Dist_INT8`                                                    | 300 | Unlimited |
...
| `/api/v2/videos/upscales`                   | `RealESRGAN_x4plus`                                                       | 300 | Unlimited |
| `/api/v2/audio/speech`                      | `Kokoro`, `Chatterbox`, `Qwen3_TTS`                                       | 300 | Unlimited |
| `/api/v2/audio/music`                       | `ACE-Step-v1.5-turbo`                                                     | 300 | Unlimited |
