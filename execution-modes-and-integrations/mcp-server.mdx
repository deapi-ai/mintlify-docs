...
| `video_url_transcription`        | Transcribe videos from URLs (YouTube, etc.)   |
...
| `audio_transcription`       | Transcribe audio files to text using Whisper  |
| `audio_transcription_price` | Calculate price for audio transcription       |

#### Prompt Enhancement

| Tool                    | Description                                       |
| ----------------------- | ------------------------------------------------- |
| `enhance_image_prompt`  | Optimize text prompts for better image generation |
| `enhance_video_prompt`  | Optimize prompts for video generation             |
| `enhance_speech_prompt` | Optimize text for speech synthesis                |
