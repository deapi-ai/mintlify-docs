...
- Remove backgrounds and upscale images and videos and videos
...
| `video_background_removal`       | Remove background from videos (keyed/transparent output) — uses `/api/v2/videos/background-removals` |
...
| `video_background_removal_price` | Calculate price for video background removal                                                          |
