...
<CardGroup cols={3}>
  <Card title="Webhooks" icon="bell" href="/execution-modes-and-integrations/webhooks">
    **Recommended.** Results pushed to your server.
  </Card>
...
With webhooks, deAPI sends an HTTP POST to your server when a job completes. Configure a global webhook URL in [account settings](https://deapi.ai/dashboard/settings), or override per-request:
