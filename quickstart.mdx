...
If your bonus funds have been exhausted and you'd like to continue using the API, go to your dashboard (Billing section) and add funds via manual top-up or set up automatic top-ups.
