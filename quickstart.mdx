...
- **Transcription** — `POST /api/v2/audio/transcriptions` — Unified audio \+ video (YouTube, X, Twitch, Kick, TikTok, X/Twitter Spaces, file uploads). TikTok requires `WhisperLargeV3Ct2`.
