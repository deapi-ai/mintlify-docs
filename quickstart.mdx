...
deAPI operates on a pay-as-you-go model. At the current stage, users receive a $20 welcome bonus. Account top-ups are available through Stripe.

If your bonus funds have been exhausted and you'd like to continue using the API, go to your dashboard (Bailling section) and add funds via manual top-up or set up automatic top-ups.
