...
| `POST` | `/api/v2/videos/background-removals`            | Remove video background              | [→](/api/v2/videos/background-removals)       |
| `POST` | `/api/v2/videos/background-removals/price`      | Calculate video bg removal price     | [→](/api/v2/videos/background-removals-price) |
