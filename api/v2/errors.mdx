...
**Solution:** Verify the resource identifier (`request_id`, model name) is correct. Use the [Model Selection](/api/v2/utilities/models) endpoint to get valid model names.
