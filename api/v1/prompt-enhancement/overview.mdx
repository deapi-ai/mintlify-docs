...
|---------|----------|----------|
| [Image Prompt Booster](/api/v1/prompt-enhancement/image-prompt-booster) | `POST /prompt/image` | Text-to-image generation |
| [Video Prompt Booster](/api/v1/prompt-enhancement/video-prompt-booster) | `POST /prompt/video` | Text/image-to-video generation |
| [Speech Prompt Booster](/api/v1/prompt-enhancement/speech-prompt-booster) | `POST /prompt/speech` | Text-to-speech synthesis |
| [Image-to-Image Booster](/api/v1/prompt-enhancement/image-to-image-prompt-booster) | `POST /prompt/image2image` | Image transformation |
| [Sample Prompts](/api/v1/prompt-enhancement/sample-prompts) | `GET /prompts/samples` | Generate creative ideas |
