...
| `POST` | `/api/v1/client/img-upscale`                   | Upscale image resolution             | _Coming soon_                                     |
| `POST` | `/api/v1/client/img-upscale/price-calculation` | Calculate image upscale price        | _Coming soon_                                     |
