...
**Timestamps are charged extra on this model.** Every other source — YouTube, X, Twitch, Kick, uploaded files — is billed by duration, and on `WhisperLargeV3Ct2, requesting timestamps increases this price by +50% to the transcription price.`
