...
**Video** (Video-to-Text, Image-to-Video, Video Upscale, Video Replace):
...
- **Image Upscale** — Upscale images to higher resolution
- **Video Upscale** — Upscale videos to higher resolution
